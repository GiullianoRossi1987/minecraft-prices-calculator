...
CREATE TABLE IF NOT EXISTS MPC.MINECRAFT_ITEM(
...
CREATE TABLE IF NOT EXISTS MPC.ITEM_SELL(
	CD       SERIAL PRIMARY KEY NOT NULL,
	ID_ITEM  INT                REFERENCES MPC.MINECRAFT_ITEM(CD),
...
CREATE TABLE IF NOT EXISTS MPC.SERVICE_SELL(
	CD              SERIAL PRIMARY KEY NOT NULL,
	ID_ITEM_SERVICE INT                REFERENCES MPC.MINECRAFT_ITEM(CD),
	QT_ITEM         INT                NOT NULL DEFAULT 1,
	VN_BUYER        MONEY              NOT NULL,
